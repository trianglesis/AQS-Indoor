...
esp_err_t setup_db(void) {
    ...
    */
    ...
    xTaskCreatePinnedToCore(check_or_create_table, "table-create", 1024*6, (void *)test_table, 4, NULL, tskNO_AFFINITY);
    xTaskCreatePinnedToCore(check_or_create_table, "table-create", 1024*6, (void *)battery_table, 4, NULL, tskNO_AFFINITY);
    xTaskCreatePinnedToCore(check_or_create_table, "table-create", 1024*6, (void *)bme680_table, 4, NULL, tskNO_AFFINITY);
    xTaskCreatePinnedToCore(check_or_create_table, "table-create", 1024*6, (void *)co2_table, 4, NULL, tskNO_AFFINITY);
    return ESP_OK;
}